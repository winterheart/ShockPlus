...
void (*flat8_function_table[GRD_FILL_TYPES][GRD_FUNCS * REAL_BMT_TYPES])() = {
    {
        ...
        (ptr_type)gr_not_imp, //### MLA- not supposed to be used // (ptr_type)gri_opaque_true_lin_umap_init,
        /* Linear mappers */
        gr_null,
        gr_null,
        gr_null,
    ...
    },
    {
        ...
        gr_null,
        (ptr_type)gr_not_imp,
        gr_null, //### MLA- not supposed to be used // gri_opaque_clut_true_lin_umap_init,   /* Linear mappers */
        gr_null,
        gr_null,
        (ptr_type)gr_not_imp,
        gr_null, //### MLA- not supposed to be used // gri_opaque_clut_true_lin_umap_init,
