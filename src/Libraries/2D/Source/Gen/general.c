...
void (*gen_func[grd_FUNCS])() = {
    ...
    gen_clear, gen_upoint, gen_point, gen_uhline, gen_hline, gen_uvline, gen_vline, gen_urect, gen_rect, gen_ubox,
    gen_box,

    gen_fix_uline, gen_fix_line, gen_fix_upoly, gen_fix_poly, gen_fix_uspoly, gen_fix_spoly, gen_fix_ucpoly,
    gen_fix_cpoly, gen_fix_utmap, gen_fix_tmap,

    gen_int_ucircle, gen_int_circle, gen_fix_ucircle, gen_fix_circle, gen_int_udisk, gen_int_disk, gen_fix_udisk,
    gen_fix_disk, gen_int_urod, gen_int_rod, gen_fix_urod, gen_fix_rod,

    /* bitmap drawing functions. */
    gr_null, /* draw bitmap device->device */
    gr_null, gen_mono_ubitmap, gen_mono_bitmap, gen_flat8_ubitmap, gen_flat8_bitmap, gr_null, /* draw 24 bit */
    gr_null, gen_rsd8_ubitmap, gen_rsd8_bitmap,

    /* bitmap get functions. */
    gr_null,                                                       /* get bitmap device->device */
    gr_null, gr_null,                                              /* get mono bitmap */
    gr_null, gen_get_flat8_ubitmap, gen_get_flat8_bitmap, gr_null, /* get 24 bit bitmap */
    gr_null, gr_null,                                              /* get rsd8 bitmap */
    gr_null,

    /* bitmap transform functions. */
    gen_scale_ubitmap, gen_scale_bitmap, gen_roll_ubitmap, gen_roll_bitmap,

    /* text/font functions. */
    gen_ustring, gen_string,

    /* span drawing functions. */
    gen_solid_lr, gen_opaque_lrpp, gr_null, /* draw_lrii */
    gr_null,                                /* draw_lrcc */
