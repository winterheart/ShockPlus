...
#define RECT_TEST_SECT(pr1, pr2)                                                                  \
    (((pr1)->ul.y < (pr2)->lr.y) && ((pr1)->lr.y > (pr2)->ul.y) && ((pr1)->ul.x < (pr2)->lr.x) && \
     ((pr1)->lr.x > (pr2)->ul.x))
...
#define RECT_ENCLOSES(pr1, pr2)                                                                      \
    (((pr1)->ul.y <= (pr2)->ul.y) && ((pr1)->lr.y >= (pr2)->lr.y) && ((pr1)->ul.x <= (pr2)->ul.x) && \
     ((pr1)->lr.x >= (pr2)->lr.x))

#define RECT_TEST_PT(prect, pt) \
    (((pt).y >= (prect)->ul.y) && ((pt).y < (prect)->lr.y) && ((pt).x >= (prect)->ul.x) && ((pt).x < (prect)->lr.x))
