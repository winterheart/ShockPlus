...
static uchar numtypes_array[NUM_CLASSES][MAX_SUBCLASSES] = {
    ...
    },
    {
        // CLASS_HARDWARE
        NUM_GOGGLE_HARDWARE,
        NUM_HARDWARE_HARDWARE
    },
    {
        // CLASS_SOFTWARE
        NUM_OFFENSE_SOFTWARE,
        NUM_DEFENSE_SOFTWARE,
    ...
    {
        // CLASS_BIGSTUFF
        NUM_ELECTRONIC_BIGSTUFF,
        NUM_FURNISHING_BIGSTUFF,
        NUM_ONTHEWALL_BIGSTUFF,
        NUM_LIGHT_BIGSTUFF,
        NUM_LABGEAR_BIGSTUFF,
        NUM_TECHNO_BIGSTUFF,
        NUM_DECOR_BIGSTUFF,
        NUM_TERRAIN_BIGSTUFF
    },
    {
        // CLASS_SMALLSTUFF
        NUM_USELESS_SMALLSTUFF,
        NUM_BROKEN_SMALLSTUFF,
        NUM_CORPSELIKE_SMALLSTUFF,
        NUM_GEAR_SMALLSTUFF,
        NUM_CARDS_SMALLSTUFF,
        NUM_CYBER_SMALLSTUFF,
        NUM_ONTHEWALL_SMALLSTUFF,
        NUM_PLOT_SMALLSTUFF
    },
    {
        // CLASS_FIXTURE
        NUM_CONTROL_FIXTURE,
        NUM_RECEPTACLE_FIXTURE,
        NUM_TERMINAL_FIXTURE,
        NUM_PANEL_FIXTURE,
        NUM_VENDING_FIXTURE,
        NUM_CYBER_FIXTURE
    },
    ...
    {
        // CLASS_ANIMATING
        NUM_OBJECT_ANIMATING,
        NUM_TRANSITORY_ANIMATING,
    ...
    },
    {
        ...
        NUM_WASTE_CONTAINER,
        NUM_LIQUID_CONTAINER,
        NUM_MUTANT_CORPSE_CONTAINER,
        NUM_ROBOT_CORPSE_CONTAINER,
        NUM_CYBORG_CORPSE_CONTAINER,
        NUM_OTHER_CORPSE_CONTAINER
    },
    {
        // CLASS_CRITTER
        NUM_MUTANT_CRITTER,
