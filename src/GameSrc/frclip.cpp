...
struct _nVecWork _nVP[4] = {{static_cast<fix>(0xdeadbeef), -1, -64, 3, 2, static_cast<fix>(0xdeadbeef), 0xff, nVW_NXNY},
                            {static_cast<fix>(0xdeadbeef), -1, 64, 3, 0, static_cast<fix>(0xdeadbeef), 0xff, nVW_NXPY},
                            {static_cast<fix>(0xdeadbeef), 1, -64, 1, 2, static_cast<fix>(0xdeadbeef), 0xff, nVW_PXNY},
                            {static_cast<fix>(0xdeadbeef), 1, 64, 1, 0, static_cast<fix>(0xdeadbeef), 0xff, nVW_PXPY}};
